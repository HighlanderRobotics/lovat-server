...
export const singleMatchEventsAverage = async (user: User,  isPointAverage: boolean, matchKey: string, team: number, metric1: Metric, timeMin: number = 0, timeMax : number = matchTimeEnd): Promise<number> => {
    try {
