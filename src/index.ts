...
app.post('/manager/addMutablePicklist', addMutablePicklist); // Should be POST /manager/mutablepicklists
...
app.get('/API/tournament', getTournaments) // Should be GET /manager/tournaments
