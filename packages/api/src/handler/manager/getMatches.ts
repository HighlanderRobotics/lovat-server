...
import { teamMatchData } from "../../db/schema";
...
export const getMatches = async (
  ...
  try {
    ...
    if (
      (await db.query.teamMatchData.findFirst({
        where: eq(teamMatchData.tournamentKey, params.data.tournamentKey),
      })) === null
    ) {
    ...
    const qualMatches = await db.query.teamMatchData.findMany({
      where: and(
        eq(teamMatchData.tournamentKey, params.data.tournamentKey),
